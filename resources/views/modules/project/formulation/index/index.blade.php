            ...
            <div class="col">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-problem-identified" role="tabpanel"
                        ...
                        <div>
                            <livewire:projects.formulation.problem-identified.project-problem-identified
                    ...
                    <div class="tab-pane fade" id="v-pills-objectives" role="tabpanel"
                                ...
                                <div class="row mb-2">
                                    <div class="col-xl-12">
                                        <x-label-section> {{trans('general.objective_general')}}
                                            <x-tooltip-help
                                                    message="{{$messages->where('code','objetivo_general')->first()->description}}"></x-tooltip-help>
                                        </x-label-section>
                                    </div>
                                    <div class="col-xl-12">
                        ...
                        <div>
                            <livewire:projects.formulation.objectives.project-show-objectives :project="$project"
                                                                                              :messages="$messages"/>
                        </div>
                        <div class="row">
                    ...
                    <div class="tab-pane fade" id="v-pills-articulations" role="tabpanel"
                         aria-labelledby="v-pills-profile-tab">
                        <div>
                            <livewire:projects.formulation.articulations.project-show-articulations :project="$project"
                                                                                                    :messages="$messages"/>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-beneficiaries" role="tabpanel"
                         aria-labelledby="v-pills-profile-tab">
                        <div>
                            <livewire:projects.formulation.beneficiaries.project-beneficiary-management
                                    :id="$project->id" :project="$project" :messages="$messages"/>
                        </div>
                    </div>
