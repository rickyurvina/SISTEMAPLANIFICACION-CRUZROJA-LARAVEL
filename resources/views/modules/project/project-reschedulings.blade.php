...
@section('project-page')
    <div>
                    ...
                    <table class="table table-light table-hover">
                        ...
                        @foreach($project->reschedulings as $item)
                            <tr class="tr-hover text-center">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                <span class="badge badge- {{ \App\Models\Projects\Project::STATUS_BG[$item->state] }}
                                        badge-pill">
                                    {{ $item->state }}
                                </span>
                                    </div>
        ...
        <div wire:ignore>
            <livewire:projects.reschedulings.project-create-rescheduling :project="$project"/>
        </div>
        <div wire:ignore>
            <livewire:projects.reschedulings.project-edit-rescheduling :project="$project"/>
        </div>
        <div wire:ignore>
            <livewire:projects.reschedulings.project-approve-rescheduling/>
        </div>
