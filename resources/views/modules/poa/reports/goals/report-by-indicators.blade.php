<div class="row">
    @forelse($total as $index => $year)
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <strong class="font-weight-bold">{{$year['company']}} Hombres: {{$year['sum_men']}} Mujeres: {{$year['sum_women']}}</strong>
                    </h2>
                                        ...
                                        @if(is_array($activity))
                                            @if(isset($activity['activityIndicatorName']))
                                                <td class="border border-dark" style="width: 20%">
                                                   <span>
                                                     <i class="{{$activity['activityIndicatorIcon'] }}"></i>
                                                        {{ $activity['activityIndicatorName'] }}
                                                    </span>
                                                </td>
                                                @if($visibilityByMonth==true)
