    ...
    <div class="container-fluid" wire:ignore.self>
        <div class="d-flex align-items-center">
            ...
            <x-label-section>{{trans('general.attachments_files')}}
                <x-tooltip-help message="Permite subir archivos tipo .jpeg, png, pdf, doc, xslsx, txt"></x-tooltip-help>
            </x-label-section>
        </div>
        <div class="row">
        ...
        <div class="row ml-2">
            <div class="form-group  col-10 required">
                <label class="form-label" for="observations">{{ trans('general.document_detail') }}</label>
