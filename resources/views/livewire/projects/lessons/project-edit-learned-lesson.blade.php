<div>
    <div wire:ignore.self class="modal fade" id="lesson-edit-modal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="row">
                        ...
                        @if($lesson)
                            <div class="d-flex flex-wrap">
                                <div class="m-2 w-100">
                                    <livewire:components.files :modelId="$lesson->id"
                                                               model="\App\Models\Projects\ProjectLearnedLessons"
                                                               folder="learnedLessons"/>
                                </div>
                                <div class="m-2 w-100">
                                    <x-label-section>{{ trans('general.comments') }}</x-label-section>
                                    <livewire:components.comments :modelId="$lesson->id"
                                                                  class="\App\Models\Projects\ProjectLearnedLessons"
                                                                  :key="time().$lesson->id"
                                                                  identifier="learnedLessons"/>
                                </div>
                            </div>
                        @endif
                    </div>
