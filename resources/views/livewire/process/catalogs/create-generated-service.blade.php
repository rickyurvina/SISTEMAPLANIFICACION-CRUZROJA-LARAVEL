        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel">
                    {{ trans('general.add') }} {{ trans_choice('general.generated_services', 1) }}
                </h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="description" class="form-label required">{{ __('general.description') }}</label>
                        <input type="text"
...
@push('page_script')
    <script>
        Livewire.on('toggleCreatedService', () => $('#createModal').modal('toggle'));
    </script>
@endpush
