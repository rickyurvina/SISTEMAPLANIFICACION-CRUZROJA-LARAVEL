<div>
    @include('modules.budget.commitments.create.poa-create-commitment')
    @include('modules.budget.commitments.create.project-create-commitment')
                ...
                <div class="d-flex flex-wrap">
                    <div>
                        <a href="javascript:void(0)" class="btn btn-sm btn-success mr-2"
                           wire:click="saveCommitment()">{{trans('general.save')}} {{trans_choice('general.commitments',1)}}
                        </a>
                    </div>
                    <div>
