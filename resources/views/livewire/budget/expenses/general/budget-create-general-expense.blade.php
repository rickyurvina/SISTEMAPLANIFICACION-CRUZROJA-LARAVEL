<div>
    <div wire:ignore.self class="modal fade fade" id="budget-expense-general-create" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                        ...
                        <div class="col-12">
                            <table class="table table-bordered detail-table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="fs-2x fw-700" id="budget_item_code">{{$budgetItem}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            $('.select2Create').select2({
                ...
                dropdownParent: $("#budget-expense-general-create")
