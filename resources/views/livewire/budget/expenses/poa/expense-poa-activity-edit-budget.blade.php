<div>
    <div wire:ignore.self class="modal fade fade" id="budget-poa-expense-edit" style="display: none;" tabindex="-1" role="dialog" aria-hidden="true"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12 required">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" step="0.01" min="0" wire:model.defer="itemAmount" id="amount"
                                                       class="form-control @error('itemAmount') is-invalid @enderror">
                                            </div>
                                            @error('itemAmount')
                                            <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
