<div wire:ignore.self class="modal fade in" id="show-budget-expenses-project-activity" tabindex="-1" role="dialog"
                        ...
                        <div class="d-flex">
                            <div class="flex-grow-1 w-50" style="overflow: hidden auto">
                                <div class="pl-2 content-detail">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <x-content-detail>{{ $activity->company->name }}</x-content-detail>
                                    </div>
                                    <div class="d-flex flex-wrap">
                            ...
                            <div class="flex-grow-1 w-50" style="overflow: hidden auto">
                                <div class="content-detail">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <x-label-detail>{{trans('general.specific_objective')}}</x-label-detail>
                                        <x-content-detail>{{$activity->parentOfTask->objective->name ?? ''}}</x-content-detail>
                                    </div>
                                    <div class="d-flex flex-wrap">
                                        <x-label-detail>{{ trans_choice('general.result',1) }}</x-label-detail>
                                        <x-content-detail>{{$activity->parentOfTask->text ?? ''}}</x-content-detail>
                                    </div>
                                    <div class="d-flex flex-wrap">
                                        <x-label-detail>{{ trans('general.service') }}</x-label-detail>
                                        <x-content-detail>{{$activity->taskable->service->name ?? ''}}</x-content-detail>
                                    </div>
                                    <div class="d-flex flex-wrap">
                                        <x-label-detail>{{ trans_choice('general.indicators',1) }}</x-label-detail>
                                        <x-content-detail>{{$activity->indicator->name ?? 'Sin Indicador Asociado'}}</x-content-detail>
                                    </div>
                                    <div class="d-flex flex-wrap">
                                        <x-label-detail>{{ trans('general.lines_action') }}</x-label-detail>
                                        <x-content-detail> {{$activity->taskable->service->lineAction->name ?? ''}}</x-content-detail>
                                    </div>
                                </div>
                            </div>
                        </div>
