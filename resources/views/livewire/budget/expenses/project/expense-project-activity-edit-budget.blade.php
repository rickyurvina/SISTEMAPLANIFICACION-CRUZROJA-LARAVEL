<div>
    <div wire:ignore.self class="modal fade fade" id="budget-expense-project-edit" style="display: none;" tabindex="-1" role="dialog" aria-hidden="true"
...
@push('page_script')
    <script>
        $(document).ready(function () {
            $('.select2Edit').select2({
                ...
                dropdownParent: $("#budget-expense-project-edit")
    ...
    <script>
        window.addEventListener('loadBudgetsEdit', event => {
            $('.select2Edit').select2({
                placeholder: "{{ trans('general.select') }}",
                dropdownParent: $("#budget-expense-project-edit")
            }).on('change', function (e) {
