                                        ...
                                        <select class="custom-select @error('userId') is-invalid @enderror" id="user_id" name="user_id" wire:model.defer="userId">
                                            @if(isset($users))
                                                @foreach($users as $user)
                                                    <option value="{{ $user->id }}" @if($user->id === user()->id) selected @endif>{{ $user->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        ...
                                        <div class="form-group col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                <div class="btn-group w-100">
                                                    ...
                                                    @error('higherBetter')
                                                    <div class="error-dropdown">{{ $errors->first('higherBetter',':message') }} </div>
                                                    @enderror
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-6 col-md-4 col-lg-4">
                                        ...
                                        <div class="btn-group w-100">
                                            ...
                                            <div class="dropdown-menu w-100">
                                                ...
                                                @endif
                                                <div class="invalid-feedback">{{ $errors->first('typeOfAggregation',':message') }} </div>
                                            </div>
