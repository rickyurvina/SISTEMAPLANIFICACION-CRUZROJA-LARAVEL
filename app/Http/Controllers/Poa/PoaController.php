...
class PoaController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->middleware('permission:poa-manage|poa-view', ['only' => ['index']]);
        $this->middleware('permission:poa-manage', ['only' =>
            [
                'store','replicate','manageCatalogActivities','destroy','deleteCatalogActivities','deleteRescheduling'
            ]]);
        $this->middleware('permission:poa-manage|poa-manage-changeGoal|poa-view-changeGoal', ['only' => ['goalChangeRequest']]);
        $this->middleware('permission:poa-manage|poa-view-changeControl|poa-manage-changeGoal', ['only' => ['goalChangeRequest']]);
        $this->middleware('permission:poa-manage|poa-approve-requests', ['only' => ['goalChangeRequest']]);
        $this->middleware('permission:poa-manage|poa-manage-budget|poa-view-budget', ['only' => ['poaBudget']]);
    }
