...
namespace App\Http\Livewire\Projects\Formulation\Articulations;
...
class ProjectArticulate extends Component
{
    ...
    {
        $this->reset(['planDetailsSelected']);
        ...
        if ($this->planRegisteredTemplateDetailsSelected) {
    ...
    {
        return view('livewire.projects.formulation.articulations.project-articulate');
    }
